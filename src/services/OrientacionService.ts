...
export class OrientacionService {
    ...
    static actualizarOrientacion(id:number , nuevosDatos: Partial<OrientacionAtributos>) : Promise<OrientacionAtributos> {
        return this.orientacionRepository.actualizar(id,nuevosDatos);
    }
    static eliminarOrientacion(id:number) : Promise<void> {
